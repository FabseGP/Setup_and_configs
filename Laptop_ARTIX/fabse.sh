...
# Installation of packages from AUR; cnrdrvcups-lb only because of Canon-printer
  ...
  yay --cleanafter --nouseask -S stm32cubemx sworkstyle spicetify-cli wayfire-desktop-git avogadroapp bibata-rainbow-cursor-theme handlr-bin candy-icons-git tela-icon-theme sweet-gtk-theme-dark spotify cnrdrvcups-lb kicad-nightly-bin kicad-library-nightly kicad-library-3d-nightly otf-openmoji sunwait-git sway-launcher-desktop swaylock-fancy-git gotop-bin bastet freshfetch-bin cbonsai fuzzel nudoku clipman openrgb-bin osp-tracker macchina onlyoffice-bin standardnotes-bin revolt-desktop toilet arduino-ide-beta-bin
  yay -Scd
...
# Firefox-theme
  ...
  echo "lockPref("identity.fxaccounts.enabled",true);" >> /home/fabse/firefox/librewolf.overrides.cfg
